...
HELPER=HERE.parents[3]/'sglang/refresh/20260910_main/preflight.py'
HELPER_SHA='85e23da18f6922af3366f83028439fd14eb629843bb13edd52e38ae8ccdd739c'
ROOT=Path('/mnt/vm_8tb/b70/results/bang_isolation_20260910/native5802-conv-contract-preflight')
...
def main():
    ...
    if not args.run:
        ...
        return 0
    assert IMAGE.startswith('sha256:') and len(IMAGE)==71, 'native candidate identity pending'
    ...
    health.ROOT=ROOT
    health.IMAGES=[('native5802-conv-contract',IMAGE)]
