...
### 2026-08-21aaj - LOOP 62: attach NOMTP lmhead32 27.0 / PP 2897
...
CONFIG -> :18082 GRAPH=1 TP=1 NOMTP
  LMHEAD=1 g32
  SERVED=qwen3.8-27b-W4A8-gptq-lmhead32
  bench_code c1 vs 27.0; prefill 2048 vs 2880
...
COMMAND ->
  ...
  python3 -u vllm/w4a8/bench_prefill_ttft.py \
    http://127.0.0.1:18082/v1 \
    qwen3.8-27b-W4A8-gptq-lmhead32 2048 3
  ```

RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. prefill @2k
  pt=2045 TTFT 0.706s 2897 tok/s. Log:
  l62_w4a8_lmhead_attach_20260821T115054Z.log

VERDICT -> GO. K8 NOMTP and prefill hold.

---

### 2026-08-21aak - LOOP 63: attach DSpark+LMHEAD c1 34.7

CONTEXT -> dual with LOOP 62. Hold spec
  vs 34.7 after first-load 33.8.
  D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=34.7 best=36.3 wall~8.0s.
  this-bench mean_len=2.69 tok_rate=24.2%.
  Log:
  l63_w4a8_dspark_lmhead_attach_20260821T115054Z.log

VERDICT -> GO as hold. Warmed DSpark+LMHEAD
  matches 34.7. Do not replace 34.7 / 25.0.

---

### 2026-08-21aal - LOOP 64: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l64_w4a8_lmhead_attach_20260821T120551Z.log
...
### 2026-08-21aam - LOOP 65: attach DSpark+LMHEAD 35.8 / PP 2635

CONTEXT -> dual with LOOP 64. Hold spec
  vs 34.7. First LMHEAD spec 2k prefill.
  D14-D19 closed.

CONFIG -> :18083 GRAPH=1 DSpark k=7
  MAXSEQS=1 MAXLEN=4096 LMHEAD=1
  SERVED=qwen3.8-27b-W4A8-gptq-dspark7-lmhead32
  bench_code c1 vs 34.7; prefill 2048 vs 2615
...
COMMAND ->
  ...
  python3 -u vllm/w4a8/bench_prefill_ttft.py \
    http://127.0.0.1:18083/v1 \
    qwen3.8-27b-W4A8-gptq-dspark7-lmhead32 2048 3
  ```

RESULT -> Paris exact. 391 exact. c1
  avg=35.8 best=38.1 wall~6.9s.
  this-bench mean_len=2.88 tok_rate=26.8%.
  prefill @2k pt=2045 TTFT 0.776s 2635 tok/s
  = 0.91x vs NOMTP 2897. Log:
  l65_w4a8_dspark_lmhead_attach_20260821T120551Z.log

VERDICT -> GO as hold. Spec PP tax
  unchanged by K8. Do not replace 34.7.

---

### 2026-08-21aan - LOOP 66: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l66_w4a8_lmhead_attach_20260821T122101Z.log
...
CONTEXT -> dual with LOOP 66. Hold spec
...
RESULT -> Paris exact. 391 exact. c1
  avg=33.4 best=40.4 wall~6.3s.
  this-bench mean_len=2.62 tok_rate=23.2%.
  Log:
  l67_w4a8_dspark_lmhead_attach_20260821T122101Z.log
...
### 2026-08-21aap - LOOP 68: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l68_w4a8_lmhead_attach_20260821T123550Z.log
...
CONTEXT -> dual with LOOP 68. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=31.1 best=33.7 wall~8.4s.
  this-bench mean_len=2.41 tok_rate=20.2%.
  Log:
  l69_w4a8_dspark_lmhead_attach_20260821T123550Z.log

VERDICT -> GO as coherent hold. Weak
  accept this bench, not a new score.
  Do not replace 34.7.

---

### 2026-08-21aar - LOOP 70: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l70_w4a8_lmhead_attach_20260821T125047Z.log
...
CONTEXT -> dual with LOOP 70. Hold spec
  vs 34.7 after 31.1 low. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=33.5 best=35.8 wall~7.7s.
  this-bench mean_len=2.55 tok_rate=22.2%.
  Log:
  l71_w4a8_dspark_lmhead_attach_20260821T125047Z.log

VERDICT -> GO as hold. Recovered from
  31.1. Do not replace 34.7.

---

### 2026-08-21aat - LOOP 72: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l72_w4a8_lmhead_attach_20260821T130557Z.log
...
CONTEXT -> dual with LOOP 72. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=35.3 best=37.5 wall~6.8s.
  this-bench mean_len=2.64 tok_rate=23.4%.
  Log:
  l73_w4a8_dspark_lmhead_attach_20260821T130557Z.log

VERDICT -> GO as hold. Do not replace
  34.7.

---

### 2026-08-21aav - LOOP 74: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l74_w4a8_lmhead_attach_20260821T132046Z.log
...
CONTEXT -> dual with LOOP 74. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=34.6 best=37.0 wall~6.9s.
  this-bench mean_len=2.75 tok_rate=25.0%.
  Log:
  l75_w4a8_dspark_lmhead_attach_20260821T132046Z.log
...
### 2026-08-21aax - LOOP 76: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l76_w4a8_lmhead_attach_20260821T133548Z.log
...
CONTEXT -> dual with LOOP 76. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=32.3 best=37.2 wall~9.4s.
  this-bench mean_len=2.47 tok_rate=20.9%.
  Log:
  l77_w4a8_dspark_lmhead_attach_20260821T133548Z.log
...
### 2026-08-21abb - LOOP 80: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l80_w4a8_lmhead_attach_20260821T140549Z.log
...
CONTEXT -> dual with LOOP 80. Hold spec
  vs 34.7 after 38.8 high. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=33.4 best=36.9 wall~7.0s.
  this-bench mean_len=2.54 tok_rate=21.9%.
  Log:
  l81_w4a8_dspark_lmhead_attach_20260821T140549Z.log
...
### 2026-08-21abd - LOOP 82: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l82_w4a8_lmhead_attach_20260821T142047Z.log
...
CONTEXT -> dual with LOOP 82. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=36.9 best=41.4 wall~6.2s.
  this-bench mean_len=2.86 tok_rate=26.6%.
  Log:
  l83_w4a8_dspark_lmhead_attach_20260821T142047Z.log
...
### 2026-08-21abf - LOOP 84: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l84_w4a8_lmhead_attach_20260821T143558Z.log
...
CONTEXT -> dual with LOOP 84. Hold spec
  vs 34.7. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=38.1 best=41.7 wall~6.7s.
  this-bench mean_len=2.97 tok_rate=28.2%.
  Log:
  l85_w4a8_dspark_lmhead_attach_20260821T143558Z.log

VERDICT -> GO as hold of same config.
  Do not replace 34.7 with 38.1.

---

### 2026-08-21abh - LOOP 86: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l86_w4a8_lmhead_attach_20260821T145055Z.log
...
CONTEXT -> dual with LOOP 86. Hold spec
  vs 34.7 after 38.1 high. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=33.0 best=33.9 wall~7.8s.
  this-bench mean_len=2.69 tok_rate=24.2%.
  Log:
  l87_w4a8_dspark_lmhead_attach_20260821T145055Z.log
...
### 2026-08-21abj - LOOP 88: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l88_w4a8_lmhead_attach_20260821T150916Z.log
...
CONTEXT -> dual with LOOP 88. Hold spec
  vs 34.7 after 33.0. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=36.4 best=39.9 wall~6.4s.
  this-bench mean_len=2.71 tok_rate=24.4%.
  Log:
  l89_w4a8_dspark_lmhead_attach_20260821T150916Z.log
...
### 2026-08-21abl - LOOP 90: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l90_w4a8_lmhead_attach_20260821T152058Z.log
...
CONTEXT -> dual with LOOP 90. Hold spec
  vs 34.7 after 36.4. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=34.6 best=35.8 wall~7.1s.
  this-bench mean_len=2.81 tok_rate=25.8%.
  Log:
  l91_w4a8_dspark_lmhead_attach_20260821T152058Z.log
...
### 2026-08-21abn - LOOP 92: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l92_w4a8_lmhead_attach_20260821T153543Z.log
...
CONTEXT -> dual with LOOP 92. Hold spec
  vs 34.7 after 34.6. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=31.3 best=37.6 wall~8.6s.
  this-bench mean_len=2.42 tok_rate=20.3%.
  Log:
  l93_w4a8_dspark_lmhead_attach_20260821T153543Z.log
...
### 2026-08-21abp - LOOP 94: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l94_w4a8_lmhead_attach_20260821T155054Z.log
...
CONTEXT -> dual with LOOP 94. Hold spec
  vs 34.7 after 31.3. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=31.8 best=32.4 wall~7.9s.
  this-bench mean_len=2.56 tok_rate=22.2%.
  Log:
  l95_w4a8_dspark_lmhead_attach_20260821T155054Z.log
...
### 2026-08-21abr - LOOP 96: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l96_w4a8_lmhead_attach_20260821T160555Z.log
...
CONTEXT -> dual with LOOP 96. Hold spec
  vs 34.7 after 31.8. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=31.5 best=34.7 wall~9.1s.
  this-bench mean_len=2.40 tok_rate=19.9%.
  Log:
  l97_w4a8_dspark_lmhead_attach_20260821T160555Z.log
...
### 2026-08-21abt - LOOP 98: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l98_w4a8_lmhead_attach_20260821T162050Z.log
...
CONTEXT -> dual with LOOP 98. Hold spec
  vs 34.7 after 31.5. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=37.0 best=38.6 wall~7.1s.
  this-bench mean_len=2.90 tok_rate=27.2%.
  Log:
  l99_w4a8_dspark_lmhead_attach_20260821T162050Z.log
...
### 2026-08-21abv - LOOP 100: attach NOMTP lmhead32 27.0
...
RESULT -> Paris exact. 391 exact. c1
  avg=best 27.0 wall~9.5s. Log:
  l100_w4a8_lmhead_attach_20260821T163544Z.log
...
CONTEXT -> dual with LOOP 100. Hold spec
  vs 34.7 after 37.0. D14-D19 closed.
...
RESULT -> Paris exact. 391 exact. c1
  avg=34.1 best=35.9 wall~7.7s.
  this-bench mean_len=2.69 tok_rate=24.1%.
  Log:
  l101_w4a8_dspark_lmhead_attach_20260821T163544Z.log
