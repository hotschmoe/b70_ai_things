...
| field | value |
|---|---|
| Last loop | 42 (44fc+SO GRAPH=1: oneCCL sycl_graph allgather fail) |
| Last JOURNAL heading | `2026-08-19y` |
| Loop ledger | `docs/20260818_qwen38_w8a8_dspark_loops.md` |
| Dead-ends | `docs/20260818_qwen38_w8a8_dspark_deadends.md` |
| Next pick | Steve oneCCL 4ceafd1 rebuild then FORCE_GRAPH G1 |
| Blocked on | D14 in-image 2021.17 cannot record allgather. 101.922 not measured. |
