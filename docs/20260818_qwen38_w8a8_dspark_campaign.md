...
| field | value |
|---|---|
| Last loop | 45 (GRAPH=0 TP=2 44fc+SO c1 13.4) |
| Last JOURNAL heading | `2026-08-19ab` |
| Loop ledger | `docs/20260818_qwen38_w8a8_dspark_loops.md` |
| Dead-ends | `docs/20260818_qwen38_w8a8_dspark_deadends.md` |
| Next pick | CPU in-image 4ceafd1+kernels then GRAPH=1 G1 |
| Blocked on | D14 graph-allgather; D15 overlay device_fd. 101.922 not measured. |
