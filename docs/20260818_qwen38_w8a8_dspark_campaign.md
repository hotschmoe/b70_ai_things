...
| field | value |
|---|---|
| Last loop | 48 (D16 dump: yield+XE exec-queue poll) |
| Last JOURNAL heading | `2026-08-19ae` |
| Loop ledger | `docs/20260818_qwen38_w8a8_dspark_loops.md` |
| Dead-ends | `docs/20260818_qwen38_w8a8_dspark_deadends.md` |
| Next pick | CCL_LOG_LEVEL=info name collective; stop 60s post-compile |
| Blocked on | D16 hang is XE queue poll + sched_yield. 101.922 not measured. |
