...
| field | value |
|---|---|
| Last loop | 59 (K8 e2e int4 lm_head g32 c1 27.0 coherent, 1.08x vs 25.0). 57 NOMTP 25.0. 58 DSpark 37.9 hold. |
| Last JOURNAL heading | `2026-08-21aag` in `docs/20260820_qwen38_w4a8_journal.md` |
...
| 15m loop | ARMED `01a021be5649`. Attach `:18082` lmhead32 + `:18083` k=7 if Up. |
| Next pick | K8 on DSpark (`LMHEAD=1` restart `:18083`, keep `:18082`). Do not GRAPH=1 sglang until GRAPH=0 coherent. Do not k=3/4 / MAXSEQS=2. Do not night-train. Do not MTP (D14). Do not GRAPH=1 TP=2 (D19). Do not demote 25.0 / 34.7. Do not promote 27.0 as replacing 25.0 (1.08x < 1.10x). |
| Blocked on | nothing. `:18082` GRAPH=1 NOMTP LMHEAD=1 c1 27.0. `:18083` GRAPH=1 DSpark k=7. |
