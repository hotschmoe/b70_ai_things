...
| field | value |
|---|---|
| Last loop | 40 (k=7 restore c1 35.2 holds spec). 39 k=4 33.5 NO-GO. 38 NOMTP 25.0 holds. |
| Last JOURNAL heading | `2026-08-21zn` in `docs/20260820_qwen38_w4a8_journal.md` |
...
| 15m loop | ARMED `01a021be5649`. Attach `:18082` NOMTP + `:18083` k=7 DSpark if Up. |
| Next pick | MAXSEQS>1 on GRAPH=1 DSpark if KV fits, or SPECTOK=3. Do not retry k=4 as speed. Do not night-train. Do not MTP (D14). Do not GRAPH=1 TP=2 (D19). Do not demote 25.0 NOMTP / 34.7 spec. |
| Blocked on | nothing. `:18082` GRAPH=1 NOMTP 25.0. `:18083` GRAPH=1 DSpark k=7 MAXLEN=4096. |
