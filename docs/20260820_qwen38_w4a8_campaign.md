...
| field | value |
|---|---|
| Last loop | 61 (DSpark+LMHEAD c1 33.8 coherent, no 1.10x vs 34.7). 60 NOMTP lmhead32 27.0. |
| Last JOURNAL heading | `2026-08-21aai` in `docs/20260820_qwen38_w4a8_journal.md` |
...
| Next pick | Hold LMHEAD pair. Do not GRAPH=1 sglang until GRAPH=0 coherent. Do not k=3/4 / MAXSEQS=2. Do not night-train. Do not MTP (D14). Do not GRAPH=1 TP=2 (D19). Do not demote 25.0 / 34.7. Do not promote 27.0 as replacing 25.0. Do not promote 33.8 as replacing 34.7. |
| Blocked on | nothing. `:18082` GRAPH=1 NOMTP LMHEAD=1 c1 27.0. `:18083` GRAPH=1 DSpark k=7 LMHEAD=1 c1 33.8. |
