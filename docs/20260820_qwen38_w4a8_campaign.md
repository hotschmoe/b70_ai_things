...
| field | value |
|---|---|
| Last loop | 37 (K17 GRAPH=1 DSpark MAXLEN=4096 c1 **34.7** coherent). 36 KV miss at 8192. 35 NOMTP 25.0 holds. |
| Last JOURNAL heading | `2026-08-21zk` in `docs/20260820_qwen38_w4a8_journal.md` |
...
| 15m loop | ARMED `01a021be5649`. Attach `:18082` NOMTP + `:18083` GRAPH=1 DSpark if Up. |
| Next pick | K17 k-sweep SPECTOK=4 vs 7 on live GRAPH=1 DSpark, or MAXSEQS>1 if KV fits. Do not night-train. Do not MTP (D14). Do not GRAPH=1 TP=2 (D19). Do not demote 25.0 NOMTP. |
| Blocked on | nothing. `:18082` GRAPH=1 NOMTP 25.0. `:18083` GRAPH=1 DSpark k=7 MAXLEN=4096 c1 34.7. |
...
| Best W4A8 e2e 3.8 | GRAPH=1 DSpark k=7 `bench_code` c1 **34.7** (coherent, pos0 69%, mean_len 2.80). NOMTP honesty GRAPH=1 TP=1 **25.0**. GRAPH=0 DSpark 14.6. TP=2 GRAPH=0 3.7. TP=2 GRAPH=1 D19. MTP3 61.7 withdrawn (D14). |
| DSpark INT | off-shelf FP8 drafter on W4A8 GRAPH=1: pos0 69% mean_len 2.80 c1 34.7. No night train. |
