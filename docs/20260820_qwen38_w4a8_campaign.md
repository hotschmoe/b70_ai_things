...
| field | value |
|---|---|
| Last loop | 54 (DSpark attach c1 35.2 holds spec). 53 NOMTP c1 25.0. |
| Last JOURNAL heading | `2026-08-21aab` in `docs/20260820_qwen38_w4a8_journal.md` |
...
| Next pick | Hold vLLM pair. Do not GRAPH=1 sglang until GRAPH=0 coherent. Do not k=3/4 / MAXSEQS=2. Do not night-train. Do not MTP (D14). Do not GRAPH=1 TP=2 (D19). Do not demote 25.0 / 34.7. |
