...
> ornith_o3 UP card 0. Next **O4c** torch op or **O1** 34.9
...
0. **Ornith 35B NVFP4 (NOW, 2026-08-20bi).** GRAPH no-MTP **34.9** is
   still the recipe. L63 sticky 33.1 / L64 M1 33.3 (opt-in, extra copy).
   O2/O3 GRAPH+MTP3 INT4: code c1 21.7/21.1, VRAM win only.
   O4 proto: 1D GEMV 2.3x oneDNN isolated. O4b occupancy NO-GO (WG/SLM
   <= WG=1). Next: O4c torch op, or O1 34.9 phase_bench.
