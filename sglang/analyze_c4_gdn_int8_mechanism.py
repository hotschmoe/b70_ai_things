#!/usr/bin/env python3
"""Fail-closed analyzer for the C4 target-GDN INT8 mechanism gate."""
...
MODEL = "/models/qwen3.6-27b/w8a8-sqgptq-gdnint8"
...
def route_summary(trace_path: Path):
    ...
    checks = {
        "w8a8_m11_qkvz_48_per_step": summary["w8a8_m11_qkvz"] == 240,
        "w8a8_m11_out_64_per_step": summary["w8a8_m11_out_all"] == 320,
        "bf16_m11_qkvz_eliminated": summary["bf16_m11_qkvz"] == 0,
        ...
        "quant_m11_k5120_128_per_step": summary["quant_m11_k5120"] == 640,
...
def main() -> int:
    ...
    summary = {
        "claim": "c4_target_gdn_int8_mechanism",
        "capacity": capacity,
