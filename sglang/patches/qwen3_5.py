...
# b70 XPU patch: also register the text-only Qwen3_5ForCausalLM (for the W4A16->AWQ repack
# smoke test, whose checkpoint arch is ForCausalLM). The vision production checkpoint is
# Qwen3_5ForConditionalGeneration and does NOT need this.
EntryClass = [Qwen3_5MoeForConditionalGeneration, Qwen3_5ForConditionalGeneration, Qwen3_5ForCausalLM]
