...
class AWQConfig(QuantizationConfig):
    ...
    def get_supported_act_dtypes(self) -> List[torch.dtype]:
        # b70 XPU patch: allow bf16 acts so AWQ serves in the validated bf16 GDN regime
        # (avoids the fp16 causal_conv1d Triton dtype-mismatch crash). Weight stays 4-bit;
        # awq_dequantize output is cast to the act dtype in the apply path.
