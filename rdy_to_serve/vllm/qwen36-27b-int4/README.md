...
verified: _common smoke=GREEN 2026-06-23: eager (card0, dual-card run) AND GRAPH=1 PIECEWISE capture
(--compilation-config, full capsizes) both HEALTHY, id ok, coherent gen "Paris...". Re-verify: `bin/serve-sweep`.
